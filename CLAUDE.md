...
- 상세 페이지에 "루리웹 자동수집" 배지 + "자세한 내용과 댓글은 원문 링크에서 확인해 주세요" 고지를 붙여 회원 직접 등록 글과 명확히 구분함 — 재게시가 아니라 색인/링크 역할임을 분명히 함(제목·가격·썸네일 정도만 가져오고 본문은 안 가져옴, 원문 링크로 유도).
...
- 썸네일 이미지 표시(RSS에서 가져오긴 하나 아직 화면에 안 씀).
