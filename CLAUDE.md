...
| 지역·플레이스 노출 순위 | 네이버 오픈API 지역검색(`local.json`) + `findLocalExposureRank`(`src/lib/dashboard/exposure.ts`) | 2026-07 재도입, 아래 참고 |
